...
<head>
    ...
    <title>@yield('title', __('app.Tambah Anggaran'))</title>
</head>
<body>
@extends('layouts.app')

@section('title', __('app.Tambah Anggaran'))
    ...
    <div class="col-md-8 mx-auto">
        <div class="card shadow-sm">
            <div class="card-header bg-white border-0 py-3">
                <h4 class="mb-0">{{ __('app.Buat Anggaran Baru') }}</h4>
                ...
                <form action="{{ route('budgets.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('category_id') is-invalid @enderror" id="category_id" name="category_id" required>
                            ...
                            @empty
                                <option value="" disabled>{{ __('app.Belum ada Kategori Pengeluaran. Buat dulu di menu Kategori.') }}</option>
                            @endforelse
                        </select>
                        @error('category_id')
                            <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-calendar-plus me-1"></i> {{ __('app.Buat Anggaran') }}
                        </button>
                    </div>
                </form>
            </div>
